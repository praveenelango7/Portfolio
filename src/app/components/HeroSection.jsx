    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          Skilled React developer crafting immersive web experiences. Proficient in building dynamic, user-friendly applications. Dedicated to creating seamless interfaces that captivate and delight users.
          </p>
          <div>
            <Link
              href="/#contact"
